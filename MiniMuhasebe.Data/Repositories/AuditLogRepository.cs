    ...
    public class AuditLogRepository : BaseRepository<AuditLog>
    {
        ...
        public override AuditLog GetById(int id)
        {
            ...
            using (var connection = new SQLiteConnection(_connectionString))
            {
                ...
                {
                    if (reader.Read()) return MapAuditLog(reader);
                }
            }
            return null;
        }
        ...
        public override List<AuditLog> GetAll()
        {
            ...
            string query = "SELECT * FROM AuditLogs ORDER BY CreatedAt DESC LIMIT 1000";
            using (var connection = new SQLiteConnection(_connectionString))
            {
                connection.Open();
        ...
        public override bool Update(AuditLog entity) => false; // Audit logs are immutable
        public override bool Delete(int id) => false; // Audit logs are immutable
