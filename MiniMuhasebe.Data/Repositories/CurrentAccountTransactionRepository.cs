...
namespace MiniMuhasebe.Data.Repositories
{
    public class CurrentAccountTransactionRepository : BaseRepository<CurrentAccountTransaction>
    {
        ...
        /// <summary>
        /// Cari hesap bakiyesini hesapla (Debit - Credit)
        /// </summary>
        ...
        public override int Add(CurrentAccountTransaction entity)
        {
            string query = @"INSERT INTO CurrentAccountTransactions 
                           (CurrentAccountId, TransactionDate, Amount, TransactionType, Description, RelatedDocumentNumber, 
                            IncomeExpenseTransactionId, Notes, CreatedBy, CreatedAt)
                           VALUES (@CurrentAccountId, @TransactionDate, @Amount, @TransactionType, @Description, 
                            @RelatedDocumentNumber, @IncomeExpenseTransactionId, @Notes, @CreatedBy, @CreatedAt)";
